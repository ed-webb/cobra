package com.funbluebits.cobra.blocks.state;
...
public class SuperPistonBlockStructureHelper {
  ...
  public SuperPistonBlockStructureHelper(World worldIn, BlockPos posIn, Direction pistonFacing, boolean extending) {
    this.world = worldIn;
